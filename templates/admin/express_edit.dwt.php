		...
		<form method="post" class="form-horizontal" action="{$form_action}" name="theForm">
			<fieldset>
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="w480" type='text' name='name' value="{$expess.name}" /> 
				...
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="w480" type='text' name='user_ident' value="{$expess.user_ident}"  /> 
				...
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="w480" type="text" name="mobile" value="{$expess.mobile}" />
						<span class="input-must">{lang key='system::system.require_field'}</span>
					</div>
				</div>  
				...
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="w480" type="text" name="email" value="{$expess.email}" />
					</div>
				</div>  
				...
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="w480" type="password" name="password" value="{$expess.password}" placeholder="请输入登录密码"/>
				...
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="w480" type="text" name="address" placeholder="请输入详细地址"  value="{$expess.address}"/>
				...
				<div class="control-group formSep">
					...
					<div class="controls">
						<input class="span2" type="text" name="shippingfee_percent" value="{$expess.shippingfee_percent}"/>&nbsp;&nbsp;%
				...
				<div class="control-group formSep">
					...
					<div class="controls chk_radio">
						<input type="radio" name="work_type" value="1" {if $express.work_type eq 1} checked="true" {/if} />派单
						<input type="radio" name="work_type" value="2" {if $express.work_type eq 2} checked="true" {/if} />抢单
					</div>
				</div>
			
				<div class="control-group">
					<div class="controls">
						{if $express.user_id eq ''}
							<button class="btn btn-gebo" type="submit">确认</button>
						{else}
							<input type="hidden" name="user_id" value="{$express.user_id}" />
